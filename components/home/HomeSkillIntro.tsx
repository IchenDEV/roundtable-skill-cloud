...
export function HomeSkillIntro({ skills }: { skills: SkillRow[] }) {
  ...
  return (
    <section className="mx-auto mt-16 max-w-3xl border-t border-ink-200/40 pt-12">
      <h2 className="font-serif text-xl tracking-[0.15em] text-ink-900">可入席的视角</h2>
      ...
      <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
        {skills.map((s) => {
          ...
          return (
            <div
              key={s.skillId}
              className="rounded-xl bg-card px-4 py-3 ring-border transition-all duration-200 hover:shadow-[0_0_0_1px_var(--cinnabar)]"
            >
