-- Store the next resumable step for an interrupted stream.

alter table public.roundtable_sessions add column if not exists run_checkpoint jsonb;
...
begin
  ...
  set
    ...
    run_checkpoint = excluded.run_checkpoint,
